        ...
        <View style={styles.content}>
          ...
          <View style={styles.searchContainer}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
              ...
              <TouchableOpacity
                style={[styles.filterChip, filterStatus === 'live' && styles.filterChipActive]}
                onPress={() => setFilterStatus('live')}
              >
                <Text style={[styles.filterChipText, filterStatus === 'live' && styles.filterChipTextActive]}>
                  Live
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.filterChip, filterStatus === 'scheduled' && styles.filterChipActive]}
                onPress={() => setFilterStatus('scheduled')}
              >
                <Text style={[styles.filterChipText, filterStatus === 'scheduled' && styles.filterChipTextActive]}>
                  Scheduled
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.filterChip, filterStatus === 'ended' && styles.filterChipActive]}
                onPress={() => setFilterStatus('ended')}
              >
                <Text style={[styles.filterChipText, filterStatus === 'ended' && styles.filterChipTextActive]}>
                  Ended
                </Text>
              </TouchableOpacity>
            </ScrollView>
          ...
          {loadingSessions ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>No live sessions available at the moment.</Text>
            </View>
          ) : (
                    ...
                    <View style={styles.sessionMeta}>
                      {session.subject && (
                        <View style={styles.sessionMetaItem}>
                          <Ionicons name="book" size={14} color="#6b7280" />
                          <Text style={styles.sessionMetaText}>{session.subject.name}</Text>
                        </View>
                      )}
                      {session.viewerCount !== undefined && (
                        <View style={styles.sessionMetaItem}>
                          <Ionicons name="people" size={14} color="#6b7280" />
                          <Text style={styles.sessionMetaText}>{session.viewerCount} viewers</Text>
                        </View>
                      )}
