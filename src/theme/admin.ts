...
const ADMIN_LIGHT: AdminThemeColors = {
  ...
  dashboardStatCards: [
    { bg: '#ECFDF5', accent: '#047857', iconBg: '#D1FAE5' },
    { bg: '#ECFEFF', accent: '#0E7490', iconBg: '#CFFAFE' },
    { bg: '#FDF2F8', accent: '#9D174D', iconBg: '#FCE7F3' },
    { bg: '#EEF2FF', accent: '#4338CA', iconBg: '#E0E7FF' },
    { bg: '#F0FDFA', accent: '#0F766E', iconBg: '#CCFBF1' },
    { bg: '#F5F3FF', accent: '#6D28D9', iconBg: '#EDE9FE' },
  ] as const,
};
